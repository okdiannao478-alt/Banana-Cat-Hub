    ...
    task.spawn(function()
        ...
        pcall(function()
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "⚠️ 執行器限制",
                Text = "檢測到不支援 Hook 的執行器 (" .. executorName .. ") 已禁用自瞄以防崩潰 其餘功能正常載入",
                Duration = 15,
...
local ScriptLoadstring = [[if isfile("AutoBounty.file") then
    if readfile("AutoBounty.file") == "true" then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/okdiannao478-alt/Banana-Cat-Hub/main/BananaCatHub_v2.lua"))()
    end
end]]
